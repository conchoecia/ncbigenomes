"""
Program  : GenDB_scrape_genomes_NCBI.snakefile
Language : snakemake
Date     : 2023-08-17
...
Support  : For issues or questions, please search if the topic has been discussed already
           on github and open a new issue if not: https://github.com/conchoecia/ncbigenomes
...
Description:
  This program downloads a list of all genomes from NCBI, and filters them into four lists
    - chromsome-scale, annotated
    - chromsome-scale, unannotated
    - non-chromosome-scale, annotated
    - non-chromosome-scale, unannotated

Usage instructions:
  - In the directory in which you want the database to be generated, run:
    > snakemake --cores 1 --snakefile /path/to/GenDB_scrape_genomes_NCBI.snakefile
